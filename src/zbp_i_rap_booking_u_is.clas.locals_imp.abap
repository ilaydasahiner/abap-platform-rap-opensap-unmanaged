...
CLASS lhc_Booking IMPLEMENTATION.
  ...
  METHOD update.
    ...
    LOOP AT entities ASSIGNING FIELD-SYMBOL(<entity>).
      ...
      legacy_entity_x-_intx      = CORRESPONDING zsrap_booking_x_is( <entity> MAPPING FROM ENTITY ).
  ...
  METHOD delete.
    " The delete methods get a list of keys travelid and bookingid of the booking entities that shall be deleted
  ...
  METHOD read.
    ...
    LOOP AT keys ASSIGNING FIELD-SYMBOL(<key_parent>) GROUP BY <key_parent>-travelid .
      ...
      IF messages IS INITIAL.
        ...
        LOOP AT GROUP <key_parent> ASSIGNING FIELD-SYMBOL(<key>) GROUP BY <key>-%key.
  ...
  METHOD rba_Travel.
    "This method reads the details of a parent travel entity when a booking entity is updated
    "because we have defined in the behavior definition that the etag for the booking entity does depend on the etag of the parent entity Travel.
    ...
    "Only one function call for each requested travelid
    LOOP AT keys_rba ASSIGNING FIELD-SYMBOL(<fs_travel>) GROUP BY <fs_travel>-TravelID.
